 ...
 * @author jimmysong
 */
public class BeanValidator implements IValidator, ApplicationContextAware {
    private static final Logger logger = Logger.getLogger(BeanValidator.class);
    ...
    public boolean execute(Object context, Class type, Object value, Rule rule) {
        ...
        String beanName = rule.getParameter("bean");
        String methodName = rule.getParameter("method");
        String parameterName = rule.getParameter("param");
        try {
